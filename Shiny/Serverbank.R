...
ui <- fluidPage( titlePanel("Customer Churn Prediction"),
                 sidebarLayout(
                   ...
                   mainPanel(p("This App shows the customer's churn prediction for a regional bank using Machine Learning algorithm. Please input an appropriate value to the left side bar, thank you for using :)"),
